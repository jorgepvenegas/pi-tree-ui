...
<p align="center">
  <img src="https://raw.githubusercontent.com/jorgebucaran/tree-web/main/screenshot.png" alt="tree-web screenshot" width="720">
</p>
...
```bash
git clone https://github.com/jorgebucaran/tree-web.git ~/.pi/agent/extensions/tree-web
```
...
MIT © [Jorge Bucaran](https://github.com/jorgebucaran)
